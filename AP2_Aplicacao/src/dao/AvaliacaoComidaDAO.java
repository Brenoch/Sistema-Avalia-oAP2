...
public class AvaliacaoComidaDAO implements BaseDAO {
        ...
        if (obj instanceof AvaliacaoComida) {
            ...
            try (Connection conn = ConnectionFactory.getConnection();
                ...
                if (affectedRows > 0) {
                    ...
                    System.err.println("Nenhuma linha modificada ao salvar a Avaliação de Comida.");
                }
            ...
            System.out.println("O objeto não é uma instância de AvaliacaoComida. Não salvo no banco de dados.");
        }
    }
    ...
    public void atualizar(Object obj) {
        if (obj instanceof AvaliacaoComida) {
            ...
            System.out.println("O objeto não é uma instância de AvaliacaoComida. Não atualizado.");
        }
    }
