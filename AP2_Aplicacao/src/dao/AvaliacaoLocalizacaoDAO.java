...
public class AvaliacaoLocalizacaoDAO implements BaseDAO {
        ...
        if (obj instanceof AvaliacaoLocalizacao) {
            ...
            try (Connection conn = ConnectionFactory.getConnection();
                ...
                if (avaliacao.getRestaurante() == null || avaliacao.getRestaurante().getIdrestaurante() == 0) {
                    throw new SQLException("Restaurante ligado à avaliação é nulo ou não tem ID válido.");
                }
                if (avaliacao.getCliente() == null || avaliacao.getCliente().getIdcliente() == 0) {
                    throw new SQLException("Cliente ligado à avaliação é nulo ou não tem ID válido.");
                }
                ...
                if (affectedRows > 0) {
                    ...
                    System.err.println("Nenhuma linha modificada ao salvar a Avaliação de Localização.");
                }
            ...
            System.out.println("O objeto não é uma instância de AvaliacaoLocalizacao. Não salvo no banco de dados.");
        }
    }
    ...
    public void atualizar(Object obj) {
        if (obj instanceof AvaliacaoLocalizacao) {
            ...
            System.out.println("O objeto não é uma instância de AvaliacaoLocalizacao. Não atualizado.");
        }
    }
